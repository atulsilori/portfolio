		...
		>
			<div className={'md:w-3/4 lg:w-2/4 flex flex-col gap-y-8'}>
				<AnimationOnScroll animateIn={'animate__fadeInLeft'} animateOnce animatePreScroll={false}>
					<h1 className={'text-4xl md:text-5xl lg:text-6xl font-bold'}>
						Hey, I am <span className={'text-yellow-light dark:yellow-light'}>Atul Silori</span>
					</h1>
				</AnimationOnScroll>
				<AnimationOnScroll animateIn={'animate__fadeInUp'} delay={800} animateOnce animatePreScroll={false}>
					<h2 className={'text-xl md:text-2xl lg:text-3xl font-semibold'}>
						I am a FrontEnd React Developer based in Banglore, India.
					</h2>
				</AnimationOnScroll>
				<AnimationOnScroll animateIn={'animate__fadeInUp'} delay={1600} animateOnce animatePreScroll={false}>
					<h3 className={''}>
						Developer with over <span>2.5 years of experience</span> in industry-level application
						development.
					</h3>
				</AnimationOnScroll>
			...
			<div className={'w-1/4 md:block hidden'}>
				<AnimationOnScroll animateIn={'animate__fadeInRight'} animateOnce animatePreScroll={false}>
					<Image
						className={'min-w-[200px] animate-spin-slow'}
						alt={'hero'}
						src={require('../../assets/images/reactHero.svg')}
					/>
				</AnimationOnScroll>
			</div>
		</div>
